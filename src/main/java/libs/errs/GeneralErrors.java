...
public final class GeneralErrors {
    ...
    public static Error collectionIsTooSmall(int min, int current) {
        return Error.of("collection.is.too.small", "The collection must contain " + min + " items or more. It contains " + current + " items.");
    }

    public static Error collectionIsTooLarge(int max, int current) {
        return Error.of("collection.is.too.large", "The collection must contain " + max + " items or fewer. It contains " + current + " items.");
    }
    ...
    public static <T extends Comparable<T>> Error valueIsOutOfRange(String name, T value, T min, T max) {
        ...
        String message = String.format("Value %s for %s is out of range. Min value is %s, max value is %s.", value, name, min, max);
    ...
    public static <T extends Comparable<T>> Error valueMustBeGreaterThan(String name, T value, T min) {
        ...
        return Error.of("value.must.be.greater.than", String.format("The value of %s (%s) must be greater than %s.", name, value, min));
    }
    ...
    public static <T extends Comparable<T>> Error valueMustBeGreaterOrEqual(String name, T value, T min) {
        ...
        return Error.of("value.must.be.greater.or.equal", String.format("The value of %s (%s) must be greater than or equal to %s.", name, value, min));
    }
    ...
    public static <T extends Comparable<T>> Error valueMustBeLessThan(String name, T value, T max) {
        ...
        return Error.of("value.must.be.less.than", String.format("The value of %s (%s) must be less than %s.", name, value, max));
    }
    ...
    public static <T extends Comparable<T>> Error valueMustBeLessOrEqual(String name, T value, T max) {
        ...
        return Error.of("value.must.be.less.or.equal", String.format("The value of %s (%s) must be less than or equal to %s.", name, value, max));
    }
